...
check("Product B  NQ short", 23713.75, 23729.25, [23707.55, 23701.35, 23690.50], [0.4, 0.8, 1.5])
...
check("Product A MNQ long", 26877.00, 26871.15, [26879.925, 26882.85], [0.5, 1.0], tol=1e-6)
